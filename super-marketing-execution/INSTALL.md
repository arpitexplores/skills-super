...
5. Rename the extracted folder from `super-marketing-execution-main` to `super-marketing-execution`.
6. Copy the renamed `super-marketing-execution` folder into your agent's skills directory.
...
This repository is the `super-marketing-execution` skill. Keep the full `super-marketing-execution` folder together when installing it.
