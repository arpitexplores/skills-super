...
5. Rename the extracted folder from `super-gaming-3d-media-main` to `super-gaming-3d-media`.
6. Copy the renamed `super-gaming-3d-media` folder into your agent's skills directory.
...
This repository is the `super-gaming-3d-media` skill. Keep the full `super-gaming-3d-media` folder together when installing it.
