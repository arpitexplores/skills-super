...
5. Open the extracted `skills-super-main` folder.
6. Copy the specific `super-*` skill folder you want into your agent's skills directory.
...
```bash
cp -R super-example ~/.your-agent/skills/
```

Replace `super-example` with the skill you want to use, such as `super-seo-foundation` or `super-ai-ml-agents`.
