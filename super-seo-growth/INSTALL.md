...
5. Rename the extracted folder from `super-seo-growth-main` to `super-seo-growth`.
6. Copy the renamed `super-seo-growth` folder into your agent's skills directory.
...
This repository is the `super-seo-growth` skill. Keep the full `super-seo-growth` folder together when installing it.
